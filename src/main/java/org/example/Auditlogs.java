...
public class Auditlogs {
    ...
    public void TC02(String testUser) throws IOException, InterruptedException {
        ...
        if (expectedDescription.contains("logged in") && expectedDescription.contains(testUser)) {
            ...
            softAssert.assertEquals(accessDetails, "Desktop, Edge 127.0.0.0");
...
//
    ...
    public void TC06(String testUser) throws InterruptedException {
        ...
        test = extent.createTest("Step01: Verify whether user is able to deactive branding control ");
        WebElement brandingControl = driver.findElement(By.xpath("//span[text()='Branding Controls']"));
